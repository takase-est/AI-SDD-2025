...
name: context-skill
description: |
  AGENTS.mdを生成・レビュー・改善し、リポジトリ全体をコンパクトに俯瞰できるドキュメントを維持するスキル。
  このスキルは、リポジトリ分析からAGENTS.mdの生成、レビュー、改善、継続的管理までの全プロセスをガイドします。
  AGENTS.mdの生成、レビュー、改善、更新などのタスクで使用してください。
---

# AGENTS.md 包括管理スキル

このスキルは、AIエージェントが `AGENTS.md` を生成・レビュー・改善する際の包括的なガイドラインです。
...
- AGENTS.mdは常に最新の状態を保つようにしてください
- プロジェクトの変更に合わせて適切に更新してください
- DRY原則を遵守し、詳細ドキュメントとの重複を避けてください

### リポジトリ分析の徹底

- プロジェクト固有の情報を正確に把握してください
- 不明な点があればユーザーに確認してください
- 実際のコマンド、パス、パターンを含めてください

### レビューの重要性

- 生成後は必ずレビュー観点で品質を確認してください
- チェックリストを使用して漏れがないか検証してください
- 改善が必要な場合は具体的な改善案を提示してください
